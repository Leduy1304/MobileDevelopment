...
class FormBasicsDemo7 extends StatefulWidget {
  @override
  _FormBasicsDemoState createState() => _FormBasicsDemoState();
}

class _FormBasicsDemoState extends State<FormBasicsDemo7>
{
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(onPressed: (){
                      ...
                      setState(() { _selectedCity=null; _selectedGioitinh=null;});
                    }, child: Text('Reset')),
                  ],)
              ],
            ),
